    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-white/30 text-sm mt-0.5">
            Analytics and generated reports
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          {
            label: "Ready",
            value: reportsData.filter((r) => r.status === "Ready").length,
            color: "text-green-400",
            icon: CheckCircle,
          },
          {
            label: "Processing",
            value: reportsData.filter((r) => r.status === "Processing").length,
              ...
              {paginated.length > 0 ? (
                paginated.map((r) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={`text-sm font-medium ${categoryColors[r.category] || "text-white/40"}`}
                      >
                        {r.category}
                      </span>
                    </td>
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={`text-[11px] font-medium px-2.5 py-1 rounded-full ${formatStyle[r.format]}`}
                      >
                        {r.format}
                      </span>
                    </td>
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={`text-[11px] font-medium px-2.5 py-1 rounded-full ${statusStyle[r.status]}`}
                      >
                        {r.status}
                      </span>
                    </td>
